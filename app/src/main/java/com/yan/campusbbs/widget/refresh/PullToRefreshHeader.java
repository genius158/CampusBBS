...
public class PullToRefreshHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        refreshBar = header.findViewById(R.id.refresh_bar);
        resetView();
    }

    public void setRefreshBarMarginTop(int height) {
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) refreshBar.getLayoutParams();
        layoutParams.topMargin = height;
        refreshBar.setLayoutParams(layoutParams);
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.jw_ptr_pull_down_to_refresh));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.jw_ptr_pull_down));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        hideRotateView();
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(R.string.jw_ptr_refreshing);
        mLastUpdateTimeUpdater.stop();
    }
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        hideRotateView();
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(getResources().getString(R.string.jw_ptr_refresh_complete));
    ...
    private String getLastUpdateTime() {
        ...
        sb.append(getContext().getString(R.string.jw_ptr_last_update));

        if (seconds < 60) {
            sb.append(seconds + getContext().getString(R.string.jw_ptr_seconds_ago));
        } else {
            ...
            if (minutes > 60) {
                ...
                if (hours > 24) {
                    ...
                    sb.append(hours + getContext().getString(R.string.jw_ptr_hours_ago));
                }

            } else {
                sb.append(minutes + getContext().getString(R.string.jw_ptr_minutes_ago));
            }
        }
        return sb.toString();
    }
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.jw_ptr_release_to_refresh);
        }
    }
