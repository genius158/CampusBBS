...
import com.yan.campusbbs.refresh.PtrClassicFrameLayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strings.add("sdfasdf");
        strings.add("sdfasdf");
        adapter = AdapterHelper.getAdapter(this, strings);
        homeHotRv.setLayoutManager(new LinearLayoutManager(this));
